...
DATASET_DIR = "../Divisao"
RESULTS_DIR = "Resultados/Resnet50"
...
model.compile(
    ...
    loss=focal_loss(gamma=2.0, alpha=0.25),  # Usando Focal Loss
    metrics=['accuracy']
)

checkpoint_path = os.path.join(RESULTS_DIR, "resnet50.weights.h5")
...
report = classification_report(y_true, y_pred, target_names=classes_list, output_dict=True)
