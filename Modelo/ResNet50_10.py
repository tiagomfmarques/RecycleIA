...
DATASET_DIR = "../Divisao"
RESULTS_DIR = "Resultados/ResNet50_10runs"
...
def build_model(num_classes):
    ...
    # Congelar quase tudo e treinar só as últimas 10 camadas
...
for run in range(1, RUNS + 1):
    ...
    checkpoint_path = os.path.join(run_dir, "resnet50_best.weights.h5")
    ...
    y_true_int = np.concatenate([y.numpy() for x, y in test_ds], axis=0)  # Rótulos inteiros
